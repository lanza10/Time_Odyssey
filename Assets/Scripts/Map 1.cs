...
//     version 1.6.3
//     from Assets/Scripts/Map 1.inputactions
//
...
public partial class @Map1: IInputActionCollection2, IDisposable
{
    ...
    {
        private @Map1 m_Wrapper;
        public ExploracionActions(@Map1 wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @Map1 m_Wrapper;
        public ConversacionActions(@Map1 wrapper) { m_Wrapper = wrapper; }
